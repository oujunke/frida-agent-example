CAAC,GAAG,CAAC,0BAA0B,CAAC,CAAC;QACxC,OAAO;KACV;IACD,IAAI,gBAAgB,GAAG,IAAI,cAAc,CACrC,kBAAkB,EAClB,SAAS,EACT,CAAC,SAAS,EAAE,KAAK,EAAE,KAAK,CAAC,CAC5B,CAAC;IACF,WAAW,CAAC,OAAO,CAAC,gBAAgB,EAAE,IAAI,cAAc,CAAC,UAAU,KAAK,EAAE,YAAY,EAAE,cAAc;QAClG,IAAI,CAAC,4BAA4B,CAAC,CAAC;QACnC,IAAI,UAAU,GAAG,gBAAgB,CAAC,KAAK,EAAE,YAAY,EAAE,cAAc,CAAC,CAAC;QACvE,mBAAmB,CAAC,UAAU,EAAE,kCAAkC,EAAE,CAAC,CAAC,CAAC;QACvE,OAAO,UAAU,CAAC;IACtB,CAAC,EAAE,SAAS,EAAE,CAAC,SAAS,EAAE,KAAK,EAAE,KAAK,CAAC,CAAC,CAAC,CAAC;IAC1C,IAAI,qBAAqB,GAAC,MAAM,CAAC,gBAAgB,CAAC,UAAU,EAAE,qBAAqB,CAAC,CAAC;IACrF,IAAG,qBAAqB,IAAE,IAAI,EAAC;QAC3B,OAAO,CAAC,GAAG,CAAC,6BAA6B,CAAC,CAAC;QAC3C,OAAO;KACV;IACD,IAAI,mBAAmB,GAAG,IAAI,cAAc,CACxC,qBAAqB,EACrB,KAAK,EACL,CAAC,SAAS,EAAE,KAAK,EAAE,MAAM,CAAC,CAC7B,CAAC;IACF,WAAW,CAAC,OAAO,CAAC,mBAAmB,EAAE,IAAI,cAAc,CAAC,UAAU,OAAO,EAAE,MAAM,EAAE,KAAK;QACxF,IAAI,MAAM,IAAI,kCAAkC,EAAE;YAC9C,OAAO,CAAC,GAAG,CAAC,+BAA+B,CAAC,CAAC;YAC7C,OAAO,KAAK,CAAC;SAChB;QACD,OAAO,mBAAmB,CAAC,OAAO,EAAE,MAAM,EAAE,KAAK,CAAC,CAAC;IACvD,CAAC,EAAE,KAAK,EAAE,CAAC,SAAS,EAAE,KAAK,EAAE,MAAM,CAAC,CAAC,CAAC,CAAC;IACvC,YAAY,GAAC,IAAI,CAAC;IAClB,OAAO,CAAC,GAAG,CAAC,oBAAoB,CAAC,CAAC;AACtC,CAAC;AACD,IAAI,YAAY,GAAC,KAAK,CAAC;AACvB,SAAS,OAAO;IACZ,IAAG,YAAY,EAAC;QACZ,OAAO,CAAC,GAAG,CAAC,sBAAsB,CAAC,CAAC;QACpC,OAAO;KACV;IACD,UAAU,EAAE,CAAC;AACjB,CAAC;AACD,OAAO,EAAC,OAAO,EAAC,CAAC"}
✄
function disableImp() {
    var errSSLServerAuthCompleted = -9481;
    var kSSLSessionOptionBreakOnServerAuth = 0;
    ...
    if (exSSLHandshake == null) {
        console.log('SSLHandshake is null');
        return;
    }
    ...
    Interceptor.replace(SSLHandshake, new NativeCallback(function (context) {
        var result = SSLHandshake(context);
        if (result == errSSLServerAuthCompleted) {
            console.log("Replacing SSLHandshake");
            return SSLHandshake(context);
        }
        return result;
    }, 'int', ['pointer']));
    ...
    if (exSSLCreateContext == null) {
        console.log('SSLCreateContext is null');
        return;
    }
    ...
    if (exSSLSetSessionOption == null) {
        console.log('SSLSetSessionOption is null');
        return;
    }
    var SSLSetSessionOption = new NativeFunction(exSSLSetSessionOption, 'int', ['pointer', 'int', 'bool']);
    Interceptor.replace(SSLSetSessionOption, new NativeCallback(function (context, option, value) {
        if (option == kSSLSessionOptionBreakOnServerAuth) {
            console.log("Replacing SSLSetSessionOption");
            return noErr;
        }
        return SSLSetSessionOption(context, option, value);
    }, 'int', ['pointer', 'int', 'bool']));
    isDisableImp = true;
    console.log('disableSsl success');
}
var isDisableImp = false;
function disable() {
    if (isDisableImp) {
        console.log('isDisableImp is true');
        return;
    }
    disableImp();
}
